...
/**
 * Tests for {@link ExampleRest.ExampleRestApplication}.
 */
public final class ExampleRestTests {
    ...
    @ClassRule
    public static final DropwizardAppRule<ExampleRest.ExampleRestConfiguration> RULE = new DropwizardAppRule<>(
            ExampleRest.ExampleRestApplication.class,
            ExampleRest.ExampleRestApplication.class.getClassLoader().getResource("example-rest.yml").getPath());
    ...
    public void testCorsHeadersAppliedToApi() {
        ...
        assertEquals(ExampleRest.EXAMPLES_RESOURCE_RESPONSE, response.readEntity(String.class));
